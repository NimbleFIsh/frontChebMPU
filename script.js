...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const setMarker = (coords, icon=marker, size=[20, 20], callback = console.log) => L.marker(coords, {icon:L.icon({iconUrl:markersParh + icon,iconSize:icon == 'marker.png' ? [20, 40] : size,iconAnchor:[5,35],popupAnchor:[0,-40]})}).addEventListener('click', callback).addTo(map);
